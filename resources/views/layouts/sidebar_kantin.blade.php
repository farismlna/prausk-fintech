...
<body style="background-color: #F1F5F9">
    <div id="app">
        <div class="" style="height: 100%; width: 260px; position: fixed; z-index: 1; top: 0; left: 0; background-color: hsl(223, 72%, 37%); overflow-x: hidden; padding-top: 20px">
            <p class="mb-3" style="padding: 6px 8px 6px 35px; font-size: 25px; font-weight: bold; color: white; display: block; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Fintech Kantin</p>
            <a style="padding: 6px 8px 6px 35px; text-decoration: none; font-size: 20px; color: white; display: block;" href="{{route('home')}}">Home</a>
            <a style="padding: 6px 8px 6px 35px; text-decoration: none; font-size: 20px; color: white; display: block;" href="{{route('product')}}">Tambah Produk</a>
            <a style="padding: 6px 8px 6px 35px; text-decoration: none; font-size: 20px; color: white; display: block;" href="#">Transaksi</a>
