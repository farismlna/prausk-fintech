                ...
                <form action="{{ route('product.update', ['id' => $product->id])}}" method="post">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" value="{{$product->name}}" placeholder="Masukkan Nama Produk" name="name" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            <label for="" class="mb-3">Stock Produk</label>
                            <input type="text" value="{{$product->stock}}" placeholder="Masukkan Stok Produk" name="stock" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" value="{{$product->price}}" placeholder="Masukkan Harga Produk" name="price" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            <label for="" class="mb-3">Deskripsi</label>
                            <textarea type="text" name="desc" placeholder="Masukkan Deskripsi Produk" class="form-control">{{$product->desc}}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
